<template>
  <div class="post-meta">
    ...
    <div v-for="item in resolvedCates" :key="item.name" class="post-meta__cates">
      <i class="icon-cate" />
    ...
    <div v-if="isShowReadCount" :id="pagePath" class="leancloud_visitors" data-flag-title="Your Article Title">
        <i class="icon-eye" />
